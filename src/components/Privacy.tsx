      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div>
            ...
            <p style={{ color: 'rgba(245,245,243,0.5)' }}>Privacy questions? Email us at <a href="mailto:ai@agentcy.co.za" className="underline" style={{ color: '#3AAFA9' }}>ai@agentcy.co.za</a>.</p>
          </div>
        </motion.div>
      </div>
    </section>
