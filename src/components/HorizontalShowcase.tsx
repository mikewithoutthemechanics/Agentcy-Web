...
// ── Client logo SVGs ────────────────────────────────
const logos = [
  <img key="logo-1" src="/logos/logo-1.svg" alt="Logo" style={{ width: '80%', height: 'auto', opacity: 0.85 }} />,
  <img key="logo-2" src="/logos/logo-2.svg" alt="Logo" style={{ width: '70%', height: 'auto', opacity: 0.85 }} />,
  <img key="logo-3" src="/logos/logo-3.svg" alt="Logo" style={{ width: '65%', height: 'auto', opacity: 0.85 }} />,
  <img key="logo-4" src="/logos/logo-4.svg" alt="Logo" style={{ width: '75%', height: 'auto', opacity: 0.85 }} />,
  <img key="logo-5" src="/logos/logo-5.svg" alt="Logo" style={{ width: '80%', height: 'auto', opacity: 0.85 }} />,
  // Remaining 3 keep abstract SVGs
